...
from users.validators import iban_validator, name_symbols_validator, two_in_row_validator, mfo_validator
...
class DataOceanUser(AbstractUser):
    ...
    company_name = models.CharField('Company name', max_length=150, default='', blank=True)
